document.addEventListener('DOMContentLoaded', function () {
    // Monta Vista CO2 Emissions Data
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            labels: labels,
            datasets: [{
                label: 'Monta Vista CO2 Emissions',
                data: montaVistaEmissions,
                borderColor: 'red',
                backgroundColor: 'rgba(255, 99, 132, 0.5)',
                hidden: false
            }, {
                label: 'Homestead CO2 Emissions',
    ...
    document.getElementById('toggleMontaVista').addEventListener('click', function () {
        toggleDataset(myChart, 'Monta Vista CO2 Emissions');
    });

    document.getElementById('toggleHomestead').addEventListener('click', function () {
        toggleDataset(myChart, 'Homestead CO2 Emissions');
    });
